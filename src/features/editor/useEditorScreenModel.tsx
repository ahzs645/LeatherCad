...
export function useEditorScreenModel() {
  ...
  return {
    layout: {
      isMobileLayout: domainModel.isMobileLayout,
      resolvedThemeMode: domainModel.resolvedThemeMode,
      shouldLoadThreeWorkbench,
    },
    canvas: {
      workspaceClassName: canvasModel.workspaceClassName,
    },
    topbar: {
      topbarProps,
    },
    ...
    modals: shellModel,
    workbench: {
      mobileShellProps: canvasModel.mobileShellProps,
      workbenchThreeWorkspaceProps: canvasModel.workbenchThreeWorkspaceProps,
      threeWorkspaceLoadingState: canvasModel.threeWorkspaceLoadingState,
      threeWorkspaceRoutePrompt: canvasModel.threeWorkspaceRoutePrompt,
      renderDesktopWorkbench: commandModel.renderDesktopWorkbench,
    },
    inputs: {
      hiddenInputs: shellModel.hiddenInputs,
      fontInput: shellModel.fontInput,
    },
  }
}
