...
export const TOOL_OPTIONS: Array<{ value: Tool; label: string }> = [
  ...
  { value: 'seam-multi', label: 'Seam (Multi-Edge)' },
  { value: 'piece-notch', label: 'Piece Notch' },
...
export const DESKTOP_TOOL_ICON_ITEMS: Array<{ value: Tool; label: string; iconSrc: string }> = [
  ...
  { value: 'seam', label: 'Seam', iconSrc: `${base}icons/jsketcher/p2p.png` },
  { value: 'seam-multi', label: 'Seam+', iconSrc: `${base}icons/jsketcher/p2p.png` },
  { value: 'piece-notch', label: 'Notch', iconSrc: `${base}icons/jsketcher/dot.png` },
