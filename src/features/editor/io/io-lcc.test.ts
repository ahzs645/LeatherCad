...
describe('importLccDocument', () => {
  ...
  it('rebuilds LCC dimension groups into a single logical dimension line', () => {
    const lcc = JSON.stringify({
      meta: { file_type: 'LeathercraftCAD', version: '2.8.3' },
      layers: [{ id: 4, chk: '-1', nam: 'Dimensions', indp: '0' }],
      shapes: [
        {
          id: 'd-text',
          type: 'TEXT',
          sp: [-9.0646915435791, 8.87255859375],
          ep: [-2.78369140625, 14.239559173584],
          ct: [-3.4973087310791, -5.23955869674683],
          w: '5.6015625',
          h: '2.66015625',
          color: 'Orange',
          dash: 'Solid',
        ...
        },
        {
          id: 'd-arrow-1',
          type: 'LINE',
          sp: [-6.2810001373291, 12.3008003234863],
          ep: [-6.2810001373291, 23],
          ct: [-6.2810001373291, 17.6504001617432],
          w: '0.0',
          h: '0.0',
          color: 'Orange',
          dash: 'Solid',
        ...
        },
        {
          id: 'd-arrow-2',
          type: 'LINE',
          sp: [-6.2810001373291, 5.69920015335083],
          ep: [-6.2810001373291, -5],
          ct: [-6.2810001373291, 0.349599987268448],
          w: '0.0',
          h: '0.0',
          color: 'Orange',
          dash: 'Solid',
