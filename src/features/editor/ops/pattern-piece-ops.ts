import { clamp, sampleShapePoints, uid } from '../cad/cad-geometry'
import type {
  LegacySeamAllowance,
  LineType,
  PatternPiece,
...
import { buildPatternPieceSeamPolygon, polygonBounds, polygonCenter } from './pattern-piece-seam-geometry'
export {
  buildPatternPieceSeamPath,
  buildPatternPieceSeamPolygon,
  polygonCenter,
} from './pattern-piece-seam-geometry'
